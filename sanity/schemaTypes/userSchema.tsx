...
export const userSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      readOnly: true,
      description:
        "If true, this user is banned and will not be shown to other users.",
    }),
    defineField({
      name: "bannedBy",
      title: "Banned By",
      ...
      to: { type: "user" },
      readOnly: true,
      description: "User who banned this user",
    ...
    defineField({
      ...
      type: "datetime",
      readOnly: true,
      description: "Date when this user was banned",
      hidden: ({ document }) => !document?.isBanned,
    }),
    defineField({
      name: "bannedReason",
      ...
      initialValue: "",
      readOnly: true,
      description: "Reason for banning this user, set by the admin",
      hidden: ({ document }) => !document?.isBanned,
    }),
    defineField({
      name: "imageUrl",
